...
\def\thesistitle{X-ray optics in new instruments for astroparticle- and astrophysics} % Title of thesis
...
%\include{tex/telescope_design}
\include{tex/coating_facility}
\include{tex/athena_coatings}
\include{tex/cast_coatings}
\include{tex/iaxo_design}
...
\include{tex/paper_chapter}
%\include{tex/multilab_app}
%\include{tex/xray-theory-app}
