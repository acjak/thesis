...
\caption{\footnotesize Graphs of cathode power output over time during a coating run. \textbf{Left:} A W/B$_4$C 10 bilayer coated using pulsed-DC sputtering on the B$_4$C material. Cathode 5 turns off in the middle of the process at every layer. \textbf{Right:} A W/B$_4$C 10 bilayer coating made without pulsed-DC sputtering. Both cathodes behave as designed during this coating run.}\label{fig:power-output}
\end{figure}
