...
\begin{figure}[!h]
	\center
	\includegraphics[width=0.47\linewidth]{figures/chamber/calibration_plot-ir-b4c.pdf}
	\includegraphics[width=0.47\linewidth]{figures/chamber/calibration_plot-w-si.pdf}
