...
\caption{\footnotesize (from \url{www.the-athena-x-ray-observatory.eu}).}\label{fig:athena_telescope}
\end{figure}
...
\caption{\footnotesize.}\label{fig:litho_process}
\end{figure}
